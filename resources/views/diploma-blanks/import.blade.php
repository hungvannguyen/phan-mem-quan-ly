                ...
                <form class="diploma-import-form" method="POST" action="{{ route('diploma-blanks.process-import') }}">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-grid-2">
                            ...
                            <div class="form-field">
                                <label for="import_date" class="field-label required">Ngày cấp</label>
                                <input type="date" id="import_date" name="import_date" class="field-input"
                                    value="{{ old('import_date', date('Y-m-d')) }}" required>
                            </div>
                        </div>
