    ...
    <div class="student-edit-page">
        ...
        <form method="POST" action="{{ route('student.update', $student->student_id) }}" class="space-y-8">
            ...
            <div class="section-card">
                ...
                @if ($student->status && $student->status === \App\Enums\StudentStatus::DropOut)
            ...
            <div class="section-card">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    @if ($student->status && $student->status === \App\Enums\StudentStatus::DropOut)
                        <button type="button" class="btn btn-primary btn-sm cursor-not-allowed opacity-50" disabled
                            title="Sinh viên đã bỏ học. Không thể thêm văn bằng.">
                        ...
                        @foreach ($degrees as $index => $degree)
                            <div class="degree-card">
                                ...
                                <div class="degree-details">
                                    ...
                                    @endif
                                    <div class="detail-item">
                                        <span class="label">Số hiệu văn bằng:</span>
                                        <span class="value">
                                    ...
                                    <div class="detail-item">
                                        <span class="label">Loại văn bằng:</span>
                                        <span class="value">
            ...
            <form id="addDegreeForm" method="POST" action="{{ route('degrees.store') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="field-group">
                        ...
                        <p class="field-description mt-1 text-sm text-gray-600">
                            <i class="fas fa-info-circle mr-1"></i>
            ...
            <form id="editDegreeForm" method="POST" action="" class="space-y-4">
                ...
                <div class="rounded-md border border-blue-200 bg-blue-50 p-3">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <div><strong>Số hiệu văn bằng:</strong> <code id="edit_diploma_serial"
                                class="rounded bg-blue-100 px-2 py-1">-</code></div>
                        <div class="mt-1"><strong>Loại văn bằng:</strong> <span id="edit_diploma_type"
