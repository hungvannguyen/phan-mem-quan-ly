            ...
            <div class="section-card">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="course" name="course" class="field-input" value="{{ old('course') }}"
                            placeholder="Nhập khóa (VD: K65)">
                        <div class="field-description">
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" id="academic_year" name="academic_year" class="field-input"
                            value="{{ old('academic_year') }}" placeholder="Nhập niên khóa (VD: 2020-2024)">
                        <div class="field-description">
