...
class DoctorateInfoExport
{
    ...
    public function generate()
    {
        ...
        \Log::info('DoctorateInfoExport: Found ' . $students->count() . ' students with doctorate degrees');
        ...
        if ($totalStudents === 0) {
            throw new \Exception('Không có dữ liệu sinh viên tiến sĩ để xuất');
        }
        ...
        foreach ($students as $student) {
            ...
            $sheet->setCellValue('I' . $currentRow, ''); // Số quyết định đánh giá luận án (trống)
        ...
        $columnWidths = [
            ...
            'G' => 12,  // Quốc tịch
            'H' => 35,  // Ngành đào tạo
            'I' => 15,  // Số QĐ đánh giá luận án
            'J' => 12,  // Ngày QĐ
            'K' => 12,  // Ngày bảo vệ
            'L' => 15,  // Số hiệu văn bằng
            'M' => 12,  // Số vào sổ
            'N' => 8,   // Khoá
            'O' => 18,  // Hình thức
            'P' => 15,  // Số quyết định
