...
/**
 * Import cho thông tin cấp chứng chỉ
 * Cấu trúc file Excel: Có thể khác với cả hai loại trên
 */
class CertificateImport implements ToModel, WithHeadingRow, WithValidation, WithBatchInserts, WithChunkReading
{
    ...
    {
        // TODO: Implement logic mapping cho Chứng chỉ
        // Cấu trúc có thể khác với các loại khác
        // Ví dụ:
        // - ho_ten => Student->full_name
        // - chung_chi_so => Degree->certificate_number
        // - loai_chung_chi => Loại chứng chỉ cụ thể
        // - ngay_cap => Degree->granting_date

        try {
            // Logic sẽ được implement sau
            // Xử lý đặc thù cho certificate
    ...
    /**
     * Validation rules cho Certificate
     */
    public function rules(): array
    {
        return [
            // TODO: Định nghĩa rules validation
            // Có thể khác với các loại khác
